...
export class LayoutBasicComponent {
  options: LayoutDefaultOptions = {
    logoExpanded: `https://upload.wikimedia.org/wikipedia/commons/f/f9/Metso-logo.png`,
    logoCollapsed: `https://upload.wikimedia.org/wikipedia/commons/f/f9/Metso-logo.png`
  };
